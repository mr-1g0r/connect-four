...
public class Board extends JPanel {
    ...
    private JButton createButton(int x, int y) {
        ...
        // add white border and removes "..." as initial basic button text
    ...
    private void handleButtonAction(int x, int y) {
        ...
        if (isMoveValid(x, y)) {
            ...
            List<JButton> winningCells = getWinningCells(x, y);
    ...
    private List<JButton> getWinningCells(final int x, final int y) {
